  ...
  return (
    ...
    >
      <Sidebar collapsible="offcanvas" variant="inset">
        ...
        <SidebarFooter>
          <a href="/" className="flex items-center text-emerald-600 hover:text-emerald-800 hover:bg-emerald-100">
          ...
          <a href="#" onClick={() => signOut()} className="flex items-center hover:text-emerald-800 hover:bg-emerald-100">
